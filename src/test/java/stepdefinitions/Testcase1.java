...
public class Testcase1 extends GLDTTestcae1 {
	...
	@When("User Enters (.*),(.*),(.*),(.*),(.*)$")
	public void user_enters_product_reason_region_ropu_country(String product, String reason, String region,
			String ropu, String country) throws Exception {
		givedetails(product, reason, region, ropu, country);
