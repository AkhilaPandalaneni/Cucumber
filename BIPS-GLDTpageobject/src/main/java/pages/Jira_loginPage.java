...
public class Jira_loginPage extends BaseClass {
	...
	public void logintojira(String uname, String pswd) throws Exception {
		...
		Thread.sleep(5000);
		driver.get(
				"https://id.atlassian.com/login?continue=https%3A%2F%2F1abc12345.atlassian.net%2Flogin%3FredirectCount%3D1%26dest-url%3D%252Fjira%252Fsoftware%252Fc%252Fprojects%252FP1%252Fissues%26application%3Djira&application=jira");
