...
import testCases.RATestcases;

public class RAUser extends RATestcases {
	...
	public void ApplyChangesPopup() throws Exception {
	...
	public void Submission_Checkbox() throws Exception {
		click_on_SubmissionCheckMark_Cancel();
		click_on_SubmissionCheckMark_Continue();
	}

	@Then("User checks the functionality of Not Applicable checkbox of Approval Column in the RALD case")
	public void Approval_Checkbox() throws Exception {
		click_on_ApprovalCheckMark_Cancel();
		click_on_ApprovalCheckMark_Continue();
	}
