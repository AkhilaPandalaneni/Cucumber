...
public class GLDTTestcae1 extends BaseClass {
	...
	@Test(priority = 5)
	public void EnterProduct(String tempproduct) throws Exception {
		gldtpage = new GLDTPage();
		Thread.sleep(5000);
		gldtpage.selectionOfProduct(tempproduct);		
		
	}
	
	@Test(priority = 6)
	public void EnterTempProduct(String product) throws Exception {
		gldtpage = new GLDTPage();
		Thread.sleep(5000);
		gldtpage.selectionOftempProduct1(product);		
